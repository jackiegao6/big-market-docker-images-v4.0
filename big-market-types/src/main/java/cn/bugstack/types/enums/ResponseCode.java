...
public enum ResponseCode {
    ...
    DEGRADE_SWITCH("0004", "活动已降级，系统出错了~"),
    RATE_LIMITER("0005", "访问限流拦截，稍后再试试吧~"),
    HYSTRIX("0006", "活动太火爆啦，等会再来吧~"),
    ...
    ACCOUNT_QUOTA_10_ERROR("ERR_BIZ_106", "账户总额度不足十次"),
    ACCOUNT_MONTH_QUOTA_ERROR("ERR_BIZ_107", "账户月额度不足"),
    ACCOUNT_MONTH_QUOTA_10_ERROR("ERR_BIZ_007", "账户月额度不足十次"),
    ACCOUNT_DAY_QUOTA_ERROR("ERR_BIZ_008", "账户日额度不足"),
    ACCOUNT_DAY_QUOTA_10_ERROR("ERR_BIZ_108", "账户日额度不足十次"),
